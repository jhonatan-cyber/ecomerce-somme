      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="mx-auto max-w-2xl rounded-[2rem] border bg-card p-10 text-center shadow-sm">
            ...
            <h1 className="mt-6 text-3xl font-black tracking-tight">Tu carrito esta vacio</h1>
            <p className="mt-3 text-muted-foreground">Todavia no agregaste productos. Volve al catalogo y empecemos a vender mejor.</p>
      ...
      <main className="container mx-auto px-4 py-10">
        <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black tracking-tight md:text-4xl">Carrito de Somme Technology</h1>
            <p className="mt-2 text-muted-foreground">Revisa cantidades, disponibilidad y avanza al checkout con una experiencia mas clara.</p>
          </div>
                  ...
                  <div className="grid gap-4 p-5 md:grid-cols-[140px_1fr_auto] md:items-center md:p-6">
                    ...
                    <div>
                      ...
                      <p className="mt-2 line-clamp-2 text-sm leading-6 text-muted-foreground">
                        {item.description || "Producto agregado desde el catalogo de Somme Technology."}
                      </p>
                      ...
                      <div className="mt-4 flex flex-wrap items-center gap-3">
                        <div className="inline-flex items-center rounded-2xl border bg-background px-2 py-1">
                          ...
                          <Button size="icon" variant="ghost" className="h-9 w-9 rounded-xl" onClick={() => updateQuantity(item.id, item.quantity + 1)}><Plus className="h-4 w-4" /></Button>
                        </div>
            ...
            <Card className="sticky top-32 rounded-[2rem] border-border/70 shadow-xl shadow-slate-950/5">
              <CardContent className="p-6">
                ...
                <div className="mt-6 space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between"><span className="text-muted-foreground">Envio</span><span className="font-semibold text-emerald-600">Gratis</span></div>
                ...
                <div className="mt-6 space-y-3 rounded-2xl border bg-slate-950 p-4 text-sm text-slate-200">
                  <p className="inline-flex items-center gap-2 font-semibold"><Truck className="h-4 w-4 text-cyan-300" /> Envio coordinado y seguimiento.</p>
